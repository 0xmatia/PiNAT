...
public class PluginActionsListAdapter extends RecyclerView.Adapter<PluginActionsListAdapter.CardHolder> {
    ...
    public PluginActionsListAdapter(List<String> cardText, Context mContext) {
        ...
        implements View.OnClickListener
    {
        ...
        public void onClick(View v) {
            if (PluginActionsListAdapter.clickListener != null)
            {
